...
public class PlayerViewDemoActivity extends YouTubeFailureRecoveryActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.youtube_view_textView).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.youtube_view_textView2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                isBackground = false;
                startActivity(new Intent(PlayerViewDemoActivity.this, PlayerViewDemoActivity.class));
            }
        });
